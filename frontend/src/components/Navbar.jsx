...
import logo from '../assets/logo/hearth-logo.svg'
			...
			<nav className="navbarNav desktopNav">
				<ul className="navbarListItems">
					<li className="navbarLogoBox" onClick={() => navigate('/')}>
						{/* <img src={logo} alt="" width='32px' height='32px' style={{marginRight: "5px"}} /> */}
						{/* <p><span style={{fontWeight: "700", fontFamily: "Libre Baskerville", fontSize: "36px"}}>hearth</span></p> */}
						{/* <p><span style={{fontWeight: "700", fontFamily: "", fontSize: "36px"}}>hearth</span></p> */}
						<p>hearth</p>
					</li>
			...
			<nav className="navbarNav mobileNav">
				<ul className="navbarListItems">
					<li className={`navbarLogoBox ${menuActive ? 'hiddenMenu' : ''}`} onClick={() => navigate('/')}>
						...
						{/* <p><span style={{fontWeight: "800"}}>Hearth</span></p> */}
						<p>hearth</p>
					</li>
